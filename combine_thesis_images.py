...
def combine_images():
    ...
    path_panda = "/home/zzn/qfl_tq/LD-Diffusion-quantum-v3/Training Codes of LD-Diffusion/training-runs/classical-panda-32/samples/000000.png"
    ...
    # For panda (32x32), nearest neighbor might be better to show pixel structure, 
    # but for thesis aesthetics, bicubic/lanczos is usually preferred unless pixel art.
    # Given it's a generated sample, let's use Lanczos.
